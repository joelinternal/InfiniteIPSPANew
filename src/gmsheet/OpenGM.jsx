        ...
        <div>
            ...
            <div className='overflow-x-auto w-full'>
                <table className="table-fixed border-collapse border border-black text-center">
                    <thead className='bg-blue-300 py-4'>
                        <tr className='whitespace-nowrap px-4 py-4 text-[14px]'>
                            <th className='px-2 py-2 border border-gray-600' rowSpan={2}>BRSPD Mgr</th>
                            <th className='px-2 py-2 border border-gray-600' rowSpan={2}>Program</th>
                            <th className='px-2 py-2 border border-gray-600' rowSpan={2}>Status</th>
                            <th className='px-2 py-2 border border-gray-600' rowSpan={2}>Name</th>
                            <th className='px-2 py-2 border border-gray-600' rowSpan={2}>Role as per SOW</th>
                            <th className='px-2 py-2 border border-gray-600' rowSpan={2}>Duration</th>
                            <th className='px-4 py-4 border-gray-600' rowSpan={2}>Start Date</th>
                            <th className='px-8 py-8 border border-gray-600' rowSpan={2}>End Date</th>
                            <th className='px-2 py-2 border border-gray-600' rowSpan={2}>Location</th>
                            <th className='px-2 py-2 border border-gray-600' rowSpan={2}>Type</th>
                            <th className='px-2 py-2 border border-gray-600' rowSpan={2}>Bill Rate</th>
                            <th className='px-2 py-2 border border-gray-600' rowSpan={2}>Pay Rate</th>
                            <th className='px-2 py-2 border border-gray-600' rowSpan={2}>Loaded Rate</th>
                            <th className='px-2 py-2 border border-gray-600' rowSpan={2}>Billable</th>
                            <th className='px-2 py-2 border border-gray-600' colSpan={3}>Cost</th>
                            <th className='px-2 py-2 border border-gray-600' colSpan={3}>Cost</th>
                            <th className='px-2 py-2 border border-gray-600' colSpan={3}>Revenue</th>
                            <th className='px-2 py-2 border border-gray-600' colSpan={3}>Revenue</th>
                            <th className='px-2 py-2 border border-gray-600' rowSpan={2}>Total Revenue</th>
                            <th className='px-2 py-2 border border-gray-600' rowSpan={2}>Total Cost</th>
                            <th className='px-2 py-2 border bg-blue-600 text-white border-gray-600' rowSpan={2}>TotalRevenue(YTD)</th>
                            <th className='px-2 py-2 border bg-blue-600 text-white border-gray-600' rowSpan={2}>TotalRevenue(YTD+Project)</th>
                        </tr>
                        <tr className='whitespace-nowrap text-[14px]'>
                    ...
                    <tbody className="divide-y divide-gray-600 bg-Black">
                        {
                            listloadrunsheet.map((row, i) => (
                                <tr>
                                    ...
                                    <td className="p-2 border border-gray-600">{row.duration}</td>
                                    <td className="p-2 border border-gray-600">{convertDate(row.startdate)}</td>
                                    <td className="p-4 border border-gray-600">{convertDate(row.enddate)}</td>
                                    <td className="p-2 border border-gray-600">{row.location}</td>
                                    <td className="p-2 border border-gray-600">{row.type}</td>
                                    <td className="p-2 border border-gray-600">{row.billrate}</td>
                                    <td className="p-2 border border-gray-600">{row.payrate}</td>
                                    <td className="p-2 border border-gray-600">{row.loadedrate ? Number(row.loadedrate).toFixed(2) : '0.00'}</td>
                                    <td className="p-2 border border-gray-600">{row.billable}</td>
                                    <td className="p-2 border border-gray-600">{row.firsthour}</td>
                                    <td className="p-2 border border-gray-600">{row.secondhour}</td>
                                    <td className="p-2 border border-gray-600">{row.thirdhour}</td>
                                    <td className="p-2 border border-gray-600">{row.costfirstmonth}</td>
                                    <td className="p-2 border border-gray-600">{row.costsecondmonth}</td>
                                    <td className="p-2 border border-gray-600">{row.costthirdmonth}</td>
                                    <td className="p-2 border border-gray-600">{row.firsthour}</td>
                                    <td className="p-2 border border-gray-600">{row.secondhour}</td>
                                    <td className="p-2 border border-gray-600">{row.thirdhour}</td>
                                    <td className="p-2 border border-gray-600">{row.revenuefirstmonth}</td>
                                    <td className="p-2 border border-gray-600">{row.revenuesecondmonth}</td>
                                    <td className="p-2 border border-gray-600">{row.revenuethirdmonth}</td>
